...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-4 pb-2 border-bottom border-light">
    <div>
        ...
        <h3 class="fw-bold mb-0 text-dark">{{ $project->title }}</h3>
    </div>
    <span class="badge px-3 py-2 rounded-pill border text-uppercase" style="background: var(--emerald-soft); color: var(--emerald-hover); font-size: 11px;">
                    ...
                    <div class="list-group-item px-0 py-3 d-flex justify-content-between align-items-center bg-transparent">
                        <div class="d-flex align-items-start gap-3">
                            <form action="{{ route('tasks.update', $task) }}" method="POST">
                                ...
                                <button type="submit" class="btn btn-sm p-0 border-0" style="color: {{ $task->status === 'completed' ? 'var(--emerald-primary)' : '#94a3b8' }};">
                            ...
                            <div>
                                ...
                                <div class="d-flex flex-wrap gap-2 align-items-center mt-1">
                                    ...
                                    @if($task->assignedUser)
                                        <span class="small fw-medium" style="font-size: 11px; color: var(--emerald-primary);">
